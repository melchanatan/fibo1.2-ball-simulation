...
def progess_page():
    global current_step, target_pos
    ### Progress Page ###
    wall_height = 50
    calculator = Calculator(GRAVITY, INITIAL_THETA)
    robot_pos = calculator.calculate_robot_pos(target_pos)
    calculator.initial_pos_x = robot_pos[0]
    initial_velocity = calculator.calculate_initial_velocity(field=wall_height)
    ...
    simulate_components = [button_next_3, button_back_3, button_plus_playback_speed, button_minus_playback_speed,
                           text_playback_speed, rec_3_1, text_pwm_simulate, text_rpm_simulate]
